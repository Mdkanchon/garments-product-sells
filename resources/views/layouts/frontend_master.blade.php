...
<head>
	...
	<link href="{{ asset('frontend_assets') }}/plugins/fontawesome-free-5.0.1/css/fontawesome-all.css" rel="stylesheet"
		type="text/css">
	<link rel="stylesheet" type="text/css"
		href="{{ asset('frontend_assets') }}/plugins/OwlCarousel2-2.2.1/owl.carousel.css">
	<link rel="stylesheet" type="text/css"
		href="{{ asset('frontend_assets') }}/plugins/OwlCarousel2-2.2.1/owl.theme.default.css">
					...
					<div class="row">
						<div class="col d-flex flex-row">
							<div class="top_bar_contact_item">
								<div class="top_bar_icon"><img src="{{ asset('frontend_assets') }}/images/phone.png"
										alt=""></div>+38 068 005 3570
							</div>
							<div class="top_bar_contact_item">
								<div class="top_bar_icon"><img src="{{ asset('frontend_assets') }}/images/mail.png"
										alt=""></div><a href="mailto:fastsales@gmail.com">eogas@gmail.com</a>
							</div>
							...
							<div class="top_bar_content ml-auto">
								...
								<div class="top_bar_user">
									<div class="user_icon">
										<img src="{{ asset('frontend_assets') }}/images/user.svg" alt="">
									</div>
									@if (Route::has('login'))
									@auth
									<div class="top_bar_menu">
										<ul class="standard_dropdown top_bar_dropdown">
											<li>
												...
												<ul>
													<li><a href="{{route('customer.index')}}">Customer Dashboard</a>
													</li>
					...
					<div class="row">
						...
						<div class="col-lg-2 col-sm-3 col-3 order-1">
							<div class="logo_container">
								...
								<a href="{{ url('/') }}">
									<img src="{{ asset('frontend_assets') }}/images/logo.png" style="width:150px"
										alt="">
									<span
										style="margin-left: 38px;font-size:18px; font-weight:bold;color:orangered">EOGAS</span>
								</a>
									...
									<div class="header_search_form_container">
										<form action="#" class="header_search_form clearfix">
											...
											<button type="submit" class="header_search_button trans_300"
												value="Submit"><img
													src="{{ asset('frontend_assets') }}/images/search.png"
													alt=""></button>
										</form>
									</div>
								</div>
							...
							<div class="wishlist_cart d-flex flex-row align-items-center justify-content-end">
								{{-- <div class="wishlist d-flex flex-row align-items-center justify-content-end">
									<div class="wishlist_icon"><img
											src="{{ asset('frontend_assets') }}/images/heart.png" alt="">
									</div>
								...
								<div class="cart">
									<div class="cart_container d-flex flex-row align-items-center justify-content-end">
										<div class="cart_icon">
											...
											<div class="cart_count"><span>{{ App\Models\Cart::where('ip_address',
													request()->ip())->count() }}</span></div>
										</div>
										<div class="cart_content">
											...
											$subtotal=0;
											@endphp
											@foreach (App\Models\Cart::where('ip_address', request()->ip())->get() as
											$price)
											@php
							...
							<div
								...
								<div class="newsletter_title_container">
									<div class="newsletter_icon"><img
											src="{{ asset('frontend_assets') }}/images/send.png" alt=""></div>
									<div class="newsletter_title">Sign up for Newsletter</div>
								</div>
								<div class="newsletter_content clearfix">
									<form action="{{ route('store.newslatter') }}" method="post"
					...
					<div class="row">
						...
						<div class="col-lg-3 footer_col">
							<div class="footer_column footer_contact">
								...
								<div class="footer_phone">+8801999793027</div>
								<div class="footer_contact_text">
									<p>Khagan, Carabag, Ashulia, Savar, Dhaka</p>
						...
						<div class="col-lg-2 offset-lg-2">
							<div class="footer_column">
								...
								<ul class="footer_list">
									...
									<li><a href="{{ url('category/product') }}/{{ $menu->id }}">{{ $menu->category_name
											}}</a></li>
									@endforeach
								</ul>
						...
						<div class="col">
							...
							<div
								...
								<div class="copyright_content">
									...
									</script> EOGAS All rights reserved
									<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
								</div>
								<div class="logos ml-sm-auto">
									<ul class="logos_list">
										<li><a href="#"><img src="{{ asset('frontend_assets') }}/images/logos_1.png"
													alt=""></a></li>
										<li><a href="#"><img src="{{ asset('frontend_assets') }}/images/logos_2.png"
													alt=""></a></li>
										<li><a href="#"><img src="{{ asset('frontend_assets') }}/images/logos_3.png"
													alt=""></a></li>
										<li><a href="#"><img src="{{ asset('frontend_assets') }}/images/logos_4.png"
													alt=""></a></li>
									</ul>
								</div>
							</div>
